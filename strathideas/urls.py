...
from strathideasapp.views import IdeaListView, home, IdeaDetailView
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='strathideasapp/user_login.html'), name='login'),
